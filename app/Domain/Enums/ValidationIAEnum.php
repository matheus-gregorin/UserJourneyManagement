...
enum ValidationIAEnum
{
    ...
    public const MESSAGENOTUNDERSTOOD = "Não foi possivel entender a mensagem, por favor, tente novamente. Caso o erro persista,  entre em contato com seu supervisor ou acesse o nosso site para mais informações. (www.userManager.com.br)";
    public const USERNOTFOUND = "Usuário não encontrado, entre em contato com seu supervisor ou acesse o nosso site para mais informações. (www.userManager.com.br).";
